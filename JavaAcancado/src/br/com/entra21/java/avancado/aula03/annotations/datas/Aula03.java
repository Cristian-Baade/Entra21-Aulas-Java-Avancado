...
public class Aula03 {
	...
	private static void aprenderDatasHumanizadas() {
		...
		System.out.println("Durante minha vida ja gastei " + vida.getYears() + " anos, " + vida.getMonths()
		...
		System.out.println("Fomo lanchar as: " + lanche + " vamos avaliar a aula as: " + avaliacao
				+ " e temos que aprender tudo ate a: " + finalAula03);
